...
def get_potential_stop_list(trip_df, stop_times_df):
    ...
    Returns
    -------
    list_l: list of start and end stops of each trip
    """
    list_l = set()
...
def add_marker_route(dict_t, t_max_stops, my_map0, G, stops):
    """
...
def add_route(dict_t, t_max_stops, map_r, stops_df, G, stops):
    """
...
def run_bus_stops(network, folder_path):
    """
