"""
This is the main file of the entire pipeline.
"""
...
||__ preprocessing (csp_pipeline.py -> data_preprocessing.py)
...
# take arguments just after python3 csp_pipeline.py run_id
try:
